...
urlpatterns = [
    ...
    path("courses/detail/", views.program_detail, name="program_detail"),
    ...
    #commentaire
    path('upload/<int:upload_id>/comment/', views.add_comment_to_upload, name='add_comment_to_upload'),
    path('video/<int:video_id>/comment/', views.add_comment_to_video, name='add_comment_to_video'),
    path('video/<int:video_id>/', views.video_detail, name='video_detail'),
    # Route pour afficher les détails d'un fichier
