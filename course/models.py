...
class Comment(models.Model):
    ...
    # Liens optionnels vers les modèles Upload et UploadVideo
    upload = models.ForeignKey('Upload', on_delete=models.CASCADE, related_name='comments', null=True, blank=True)
    upload_video = models.ForeignKey('UploadVideo', on_delete=models.CASCADE, related_name='comments', null=True, blank=True)
